...
{
	Vertices[NumCurVertices].position = vin[a]; Vertices[NumCurVertices].color = cin[a]; NumCurVertices++;
	Vertices[NumCurVertices].position = vin[b]; Vertices[NumCurVertices].color = cin[b]; NumCurVertices++;
	Vertices[NumCurVertices].position = vin[c]; Vertices[NumCurVertices].color = cin[c]; NumCurVertices++;

	Vertices[NumCurVertices].position = vin[a]; Vertices[NumCurVertices].color = cin[a]; NumCurVertices++;
	Vertices[NumCurVertices].position = vin[c]; Vertices[NumCurVertices].color = cin[c]; NumCurVertices++;
	Vertices[NumCurVertices].position = vin[d]; Vertices[NumCurVertices].color = cin[d]; NumCurVertices++;
}
